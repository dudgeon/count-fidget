"""Synchronize Q5 schematic fields and explicitly unused pad nets, without routes."""
import json
...
def sync(board):
    ...
    xml = ET.parse(OUT / 'schematic-netlist-Q5.xml').getroot()
    footprints = {fp.GetReference(): fp for fp in board.GetFootprints()}
    paths = json.loads((OUT / 'schematic-paths-Q5.json').read_text())['parts']
...
if __name__ == '__main__':
    ...
    print('Schematic fields and explicit no-connect nets synchronized in Q5 only.')
