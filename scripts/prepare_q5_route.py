"""Apply the Q5 placement model and explicitly reset Q5 routing, keeping UUIDs."""
import argparse
import json
...
def main():
    ...
    ap.parse_args()
    model=make_model();path=OUT/'click-counter-Q5.kicad_pcb'
    ...
    print('Q5 placements applied; routes reset with footprint UUIDs preserved. Run preroute_q5 next.')
