"""Measure Q4 routed centerlines and conservative via-to-land clearances.
...
path=OUT/'click-counter-Q4.kicad_pcb';b=p.LoadBoard(str(path)); fps={f.GetReference():f for f in b.GetFootprints()}
...
pairs=[('U1',32,'J1','A7'),('U1',32,'J1','B7'),('U1',33,'J1','A6'),('U1',33,'J1','B6'),('U3',6,'C5',1),('U3',1,'C6',1),('U3',2,'R30',2),('U3',2,'R31',1),('U2',10,'C1',1),('U2',1,'C2',1),('U2',2,'C3',1),('U5',8,'C9',1),('U6',1,'C20',1),('U6',4,'C28',2),('U7',4,'C29',2),('U8',8,'C36',1),('U8',8,'C30',1),('U1',1,'C31',1),('U1',9,'C35',1),('U1',24,'C34',1),('U1',36,'C33',1),('U1',48,'C32',1),('U4',4,'C4',2),('U4',5,'C4',1),('D1',5,'C38',1),('D2',5,'C39',1),('Q3',1,'R14',1),('Q4',1,'R15',1)]
paths=[shortest(*v) for v in pairs]
grounds=[shortest(ref,pin,nearest_via=True) for ref,pin in [('C5',2),('C6',2),('C1',2),('C2',2),('C3',2),('C9',2),('C20',2),('C30',2),('C36',2),('C31',2),('C32',2),('C33',2),('C34',2),('C35',2)]]
gaps=[]
for t in tracks:
...
print('Q4 route measurements saved; inspect actual paths and retained qualification limits.')
