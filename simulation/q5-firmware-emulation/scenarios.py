...
class Suite:
    ...
    def battery_power(self):
        ...
        s.run(80.0)
        s.press(85.0, 'inc', 0.003, bounce_ms=0.5, bounces=2)   # C40 10 nF: a 10 ms tap now latches (typ need 10.5 ms)
        s.run(86.0)
        r = self.record('B4 3 ms tap from off is too short to latch U7', s)
